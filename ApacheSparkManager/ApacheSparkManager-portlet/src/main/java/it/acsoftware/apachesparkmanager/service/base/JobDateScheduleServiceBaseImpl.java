...
import it.acsoftware.apachesparkmanager.service.JobDateScheduleService;
...
/**
 * Provides the base implementation for the job date schedule remote service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link it.acsoftware.apachesparkmanager.service.impl.JobDateScheduleServiceImpl}.
 * </p>
 *
 ...
 * @generated
 */
public abstract class JobDateScheduleServiceBaseImpl extends BaseServiceImpl
    implements JobDateScheduleService, IdentifiableBean {
    ...
    private JobDateScheduleServiceClpInvoker _clpInvoker = new JobDateScheduleServiceClpInvoker();

    /*
     * NOTE FOR DEVELOPERS:
     *
     * Never modify or reference this class directly. Always use {@link it.acsoftware.apachesparkmanager.service.JobDateScheduleServiceUtil} to access the job date schedule remote service.
     */
