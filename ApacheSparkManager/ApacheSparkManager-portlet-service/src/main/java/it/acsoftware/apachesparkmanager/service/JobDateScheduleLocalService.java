...
/**
 * Provides the local service interface for JobDateSchedule. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author Brian Wing Shun Chan
 * @see JobDateScheduleLocalServiceUtil
...
public interface JobDateScheduleLocalService extends BaseLocalService,
    InvokableLocalService, PersistedModelLocalService {
    /*
     * NOTE FOR DEVELOPERS:
     *
     * Never modify or reference this interface directly. Always use {@link JobDateScheduleLocalServiceUtil} to access the job date schedule local service. Add custom service methods to {@link it.acsoftware.apachesparkmanager.service.impl.JobDateScheduleLocalServiceImpl} and rerun ServiceBuilder to automatically copy the method declarations to this interface.
     */
