 ...
 * @generated
 */
public class JobDateScheduleLocalServiceClp
    ...
    public JobDateScheduleLocalServiceClp(
        ...
        _methodName19 = "saveOrUpdareJobDateSchedule";
        ...
        _methodName21 = "fireApacheSparkJobDate";
    ...
    public it.acsoftware.apachesparkmanager.model.JobDateSchedule addJobDateSchedule(
        ...
        try {
            returnObj = _invokableLocalService.invokeMethod(_methodName0,
                    ...
                    new Object[] { ClpSerializer.translateInput(jobDateSchedule) });
        } catch (Throwable t) {
        ...
        return (it.acsoftware.apachesparkmanager.model.JobDateSchedule) ClpSerializer.translateOutput(returnObj);
    }
    ...
    public it.acsoftware.apachesparkmanager.model.JobDateSchedule createJobDateSchedule(
        ...
        try {
            returnObj = _invokableLocalService.invokeMethod(_methodName1,
                    _methodParameterTypes1, new Object[] { jobDateScheduleId });
        } catch (Throwable t) {
            t = ClpSerializer.translateThrowable(t);
    ...
    public it.acsoftware.apachesparkmanager.model.JobDateSchedule deleteJobDateSchedule(
        ...
        try {
            returnObj = _invokableLocalService.invokeMethod(_methodName2,
                    _methodParameterTypes2, new Object[] { jobDateScheduleId });
        } catch (Throwable t) {
            t = ClpSerializer.translateThrowable(t);
    ...
    public it.acsoftware.apachesparkmanager.model.JobDateSchedule fetchJobDateSchedule(
        ...
        try {
            returnObj = _invokableLocalService.invokeMethod(_methodName10,
                    _methodParameterTypes10, new Object[] { jobDateScheduleId });
        } catch (Throwable t) {
            t = ClpSerializer.translateThrowable(t);
    ...
    public it.acsoftware.apachesparkmanager.model.JobDateSchedule getJobDateSchedule(
        ...
        try {
            returnObj = _invokableLocalService.invokeMethod(_methodName11,
                    _methodParameterTypes11, new Object[] { jobDateScheduleId });
        } catch (Throwable t) {
            t = ClpSerializer.translateThrowable(t);
    ...
    public java.util.List<it.acsoftware.apachesparkmanager.model.JobDateSchedule> getJobDateSchedules(
        ...
        return (java.util.List<it.acsoftware.apachesparkmanager.model.JobDateSchedule>) ClpSerializer.translateOutput(returnObj);
    }
    ...
    public it.acsoftware.apachesparkmanager.model.JobDateSchedule saveOrUpdareJobDateSchedule(
        ...
        try {
            returnObj = _invokableLocalService.invokeMethod(_methodName19,
                    ...
                    new Object[] {
                        ClpSerializer.translateInput(jds),
                        
                    ClpSerializer.translateInput(currentLocale),
            ...
            if (t instanceof it.acsoftware.apachesparkmanager.BeanValidationException) {
                throw (it.acsoftware.apachesparkmanager.BeanValidationException) t;
            }
    ...
    public void fireApacheSparkJobDate(
        ...
        try {
            _invokableLocalService.invokeMethod(_methodName21,
                ...
                ClpSerializer.translateInput(inputParamsMap)
                });
        } catch (Throwable t) {
            t = ClpSerializer.translateThrowable(t);
