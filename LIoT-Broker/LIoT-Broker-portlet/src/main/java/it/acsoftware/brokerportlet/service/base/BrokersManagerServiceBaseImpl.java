...
import it.acsoftware.brokerportlet.service.BrokersManagerService;
...
/**
 * Provides the base implementation for the brokers manager remote service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link it.acsoftware.brokerportlet.service.impl.BrokersManagerServiceImpl}.
 * </p>
 *
 ...
 * @generated
 */
public abstract class BrokersManagerServiceBaseImpl extends BaseServiceImpl
    implements BrokersManagerService, IdentifiableBean {
    ...
    private BrokersManagerServiceClpInvoker _clpInvoker = new BrokersManagerServiceClpInvoker();

    /*
     * NOTE FOR DEVELOPERS:
     *
     * Never modify or reference this class directly. Always use {@link it.acsoftware.brokerportlet.service.BrokersManagerServiceUtil} to access the brokers manager remote service.
     */
