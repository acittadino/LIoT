...
/**
 * Provides the local service interface for Broker. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author Brian Wing Shun Chan
 * @see BrokerLocalServiceUtil
...
public interface BrokerLocalService extends BaseLocalService,
    InvokableLocalService, PersistedModelLocalService {
    /*
     * NOTE FOR DEVELOPERS:
     *
     * Never modify or reference this interface directly. Always use {@link BrokerLocalServiceUtil} to access the broker local service. Add custom service methods to {@link it.acsoftware.brokerportlet.service.impl.BrokerLocalServiceImpl} and rerun ServiceBuilder to automatically copy the method declarations to this interface.
     */
