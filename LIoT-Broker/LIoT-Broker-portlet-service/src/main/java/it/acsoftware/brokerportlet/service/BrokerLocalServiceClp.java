 ...
 * @generated
 */
public class BrokerLocalServiceClp implements BrokerLocalService {
    ...
    public BrokerLocalServiceClp(InvokableLocalService invokableLocalService) {
        ...
        _methodName19 = "saveOrUpdateBroker";
        ...
        _methodName20 = "startupBrokerServices";
    ...
    public it.acsoftware.brokerportlet.model.Broker addBroker(
        ...
        try {
            returnObj = _invokableLocalService.invokeMethod(_methodName0,
                    ...
                    new Object[] { ClpSerializer.translateInput(broker) });
        } catch (Throwable t) {
        ...
        return (it.acsoftware.brokerportlet.model.Broker) ClpSerializer.translateOutput(returnObj);
    }
    ...
    public it.acsoftware.brokerportlet.model.Broker createBroker(long brokerId) {
        ...
        try {
            returnObj = _invokableLocalService.invokeMethod(_methodName1,
                    _methodParameterTypes1, new Object[] { brokerId });
        } catch (Throwable t) {
            t = ClpSerializer.translateThrowable(t);
    ...
    public it.acsoftware.brokerportlet.model.Broker deleteBroker(long brokerId)
        ...
        try {
            returnObj = _invokableLocalService.invokeMethod(_methodName2,
                    _methodParameterTypes2, new Object[] { brokerId });
        } catch (Throwable t) {
            t = ClpSerializer.translateThrowable(t);
    ...
    public it.acsoftware.brokerportlet.model.Broker getBroker(long brokerId)
        ...
        try {
            returnObj = _invokableLocalService.invokeMethod(_methodName11,
                    _methodParameterTypes11, new Object[] { brokerId });
        } catch (Throwable t) {
            t = ClpSerializer.translateThrowable(t);
    ...
    public java.util.List<it.acsoftware.brokerportlet.model.Broker> getBrokers(
        ...
        return (java.util.List<it.acsoftware.brokerportlet.model.Broker>) ClpSerializer.translateOutput(returnObj);
    }
    ...
    public it.acsoftware.brokerportlet.model.Broker saveOrUpdateBroker(
        ...
        try {
            returnObj = _invokableLocalService.invokeMethod(_methodName19,
                    ...
                    new Object[] {
                        ClpSerializer.translateInput(broker),
            ...
            if (t instanceof it.acsoftware.brokerportlet.BeanValidationException) {
                throw (it.acsoftware.brokerportlet.BeanValidationException) t;
            }
